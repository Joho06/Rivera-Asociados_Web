...
<body>
   ...
   <p class="blanco">Contraseña <input type="password" placeholder="ingrese su contraseña" name="clave"></p>
   <input class="btn btn-success" type="submit" value="Ingresar">
   <a href="index.php" class="btn btn-success" style="margin-top: 10px; background: red;">Salir</a>
